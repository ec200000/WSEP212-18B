...
namespace WSEP212.ServiceLayer
{
    class StoreManager : IStoreManager
    {
        ...
        {
            return StoreManagerFacade.Instance.addItemToStorage(storeID, quantity, itemName, description, price, category);
        }

        public bool removeItemFromStorage(int storeID, int itemId)
        {
            return StoreManagerFacade.Instance.removeItemFromStorage(storeID, itemId);
        }
