...
namespace WSEP212_TESTS
{
    ...
    public class ShoppingBagTests
    {
        ...
        public void beforeTests()
        {
            ...
            ResultWithValue<int> addStoreRes = StoreRepository.Instance.addStore("SUPER PHARAM", "Ashdod", new SalesPolicy("DEFAULT", new ConcurrentLinkedList<Sale>()), new PurchasePolicy("DEFAULT", purchaseRoutes, new ConcurrentLinkedList<Sale>()), new User("admin"));
