...
namespace WSEP212_TESTS
{
    ...
    public class StoreRepositoryTests
    {
        ...
        public void Initialize()
        {
            ...
            ResultWithValue<int> storeIdRes = StoreRepository.Instance.addStore("Mega", "Ashdod", new SalePolicy("DEFAULT"), new PurchasePolicy("DEFAULT", new ConcurrentLinkedList<PurchasePredicate>()), new User("admin"));
        ...
        public void addStoreTest()
        {
            ConcurrentLinkedList<PurchaseType> purchaseRoutes = new ConcurrentLinkedList<PurchaseType>();
            purchaseRoutes.TryAdd(PurchaseType.ImmediatePurchase);
            ResultWithValue<int> addStoreBool = StoreRepository.Instance.addStore("Mega", "Holon", new SalePolicy("DEFAULT"), new PurchasePolicy("DEFAULT", new ConcurrentLinkedList<PurchasePredicate>()), new User("admin"));
            Assert.IsTrue(addStoreBool.getTag());
            int newStoreID = addStoreBool.getValue();
            addStoreBool = StoreRepository.Instance.addStore("Mega", "Holon", new SalePolicy("DEFAULT"), new PurchasePolicy("DEFAULT", new ConcurrentLinkedList<PurchasePredicate>()), new User("admin"));
